...
<div class="relative pt-12 pb-24 md:pt-20 md:pb-40 overflow-hidden">
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative hidden md:block">
                <div
                    class="absolute -top-10 -right-10 w-72 h-72 bg-tek-blue-200/60 dark:bg-tek-blue-800/20 rounded-full filter blur-3xl opacity-80 dark:opacity-70"></div>
                <div
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div
            class="absolute bottom-0 left-1/4 w-80 h-80 bg-tek-orange-100/50 dark:bg-tek-orange-900/10 rounded-full"></div>
        <!-- Additional light mode circles -->
        <div
            class="absolute top-1/2 left-1/3 w-48 h-48 bg-tek-blue-50/70 dark:bg-tek-blue-900/5 rounded-full filter blur-2xl"></div>
        <div
            class="absolute bottom-1/4 right-1/3 w-32 h-32 bg-tek-orange-50/80 dark:bg-tek-orange-900/5 rounded-full filter blur-xl"></div>
    </div>
</div>
