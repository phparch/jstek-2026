...
<div x-data="{ shareDropdown: false }" class="relative">
    ...
    <div x-show="shareDropdown"
        ...
        <button onclick="shareOnX(); document.querySelector('[x-data*=shareDropdown]').__x.$data.shareDropdown = false"
            ...
            <svg class="h-4 w-4 mr-3 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <button
            ...
            class="w-full flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
            <svg class="h-4 w-4 mr-3 text-blue-500" fill="currentColor" viewBox="0 0 24 12">
                <path
        ...
        <button
            ...
            class="w-full flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
            <svg class="h-4 w-4 mr-3 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <button
            ...
            class="w-full flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
            <svg class="h-4 w-4 mr-3 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <button
            ...
            class="w-full flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
            <svg class="h-4 w-4 mr-3 text-blue-700" fill="currentColor" viewBox="0 0 24 24">
                <path
